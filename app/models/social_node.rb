class SocialNode < ApplicationRecord
  belongs_to :word_orig, autosave: false, class_name: "Word", counter_cache: true, inverse_of: :word_orig_soc_nodes
  belongs_to :word_from, autosave: false, class_name: "Word", counter_cache: true, inverse_of: :word_from_soc_nodes
  belongs_to :word_to, autosave: false, class_name: "Word", counter_cache: true, inverse_of: :word_to_soc_nodes
end
